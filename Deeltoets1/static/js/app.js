...
(function() { //self-invoking anonymous function
	...
	Dt1.controller = { //controllers
		init : function (){
			Dt1.router.init(); //initialize routie
            Dt1.section.init(); //initialize transparency
		}
	};
    ...
    Dt1.content = { //titel, releaseDate, etc. verwijzen naar HTML 'data-bind'
        about : {
        ...
        directives: {
            cover: {
                src: function () {
                    return this.cover; //verwijst naar URL in de Dt1.content.movies.cover
                }
            }
        }
    };
    ...
    Dt1.section = {
        init: function () {
            document.getElementById("about").classList.add('active'); //eerst 'about' als active setten
            Dt1.section.about();
            Dt1.section.movies();
        },
        about: function () {
            Transparency.render(document.getElementById("about"), Dt1.content.about); //rendert de HTML section 'about'
        },
        movies: function () {
            Transparency.render(document.getElementById("movies"), Dt1.content.movies, Dt1.content.directives); //rendert de HTML section 'movies' en directives
        },
    ...
    Dt1.controller.init(); //uitvoeren van de controller, om ook daadwerkelijk iets te doen
})();